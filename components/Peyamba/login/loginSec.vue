    ...
    <div>
        ...
        <div class="top-menu-area">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                        <NuxtLink to="/peyamba" class="backto-home"><i class="fas fa-chevron-left"></i> Back to peyamba</NuxtLink>
                    </div>
                    <div class="col-lg-7 ">
                        <div class="logo">
                            <img src="@/assets/frontend/images/logo2.png" alt="logo">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="main-content inloginp">
                            <form action="#">
                                ...
                                <div class="or-content">
                                    ...
                                    <a href="#" class="or-btn"><img src="@/assets/frontend/images/google.png" alt=""> Sign Up with Google</a>
                                    <p class="or-signup">
                                        Don't have an account? <NuxtLink to="/peyamba/register">
                      Sign up here
                    </NuxtLink>
                                    </p>
                                </div>
